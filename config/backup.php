...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => Str::slug(env('APP_NAME', 'goodtechies-hq')),
        ...
        'source' => [
             ...
             */
            'databases' => [
                // The schema owner (hq_migrator) can read every table and sequence. pg_dump is
                // found on PATH and gets the connection's host, port, user and password.
                'pgsql_migrator',
            ],
        ],
        ...
        'destination' => [
             ...
             */
            'disks' => [
                // An S3 bucket at a different provider account or region than the VPS.
         ...
         *
         * Backups are encrypted at rest (spec §36). Keep this password outside the server:
     ...
     */
    'notifications' => [
        // No mail in the MVP: failures are logged, and Admin → Settings shows
        // backup_last_verified_at (written by hq:verify-backup).
        'notifications' => [
